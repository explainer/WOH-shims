...
class response {
  ...
  public function __construct( $response )
  {
    ...
    $this->response_data['txn_amount'] = $this->response_data['mc_gross'];
     ...
     */
    do_action('pdb-member_payments_pdt_response', apply_filters( 'pdbmps-template_data', $this->response_data ) );
  }
